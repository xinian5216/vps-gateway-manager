...
assert_contains "$CONF" "https_port 8443 tls-cert=" "public TLS listener present (https_port)"
assert_not_contains "$CONF" "http_port 8443 tls-cert=" "TLS options are never put on a plain http_port"
